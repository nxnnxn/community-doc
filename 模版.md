...
>在架构安全上一般依靠运营商或者云服务商强大的带宽和流量清洗的能力,在功能安全XSS 攻击、CSRF 攻击、SQL 注入一般依赖安全团队提供的二放功能包，现阶段我们主要考虑业务架构上如恶意刷单,刷接口等
...
> 总结相关话语,重点突出哪些组件保证了全局系统的高可用,哪些组件要保证高性能,哪些组件保证可扩展
...
### 6.1.接口定义
> 需要专门的定义接口工具,同时是markdown,但可以同步到apifox,apipost上,可以快速MOCK数据
### 6.2.中间件配置
